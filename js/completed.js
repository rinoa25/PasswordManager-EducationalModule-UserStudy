...
// User jumped from verification to completed page
if (checkauthentication == null) {
// User goes back to verification page
  window.location.replace("/");
}
// User progressed further than the completed page
else if (checkauthentication != null && checkauthentication != "completed.html") {
...
function myLink() {
  ...
  allowOutsideClick: false,
  allowEscapeKey: false,
  allowEnterKey:  false}).then(function(){window.location.replace("https://www.mturk.com/");});
}
