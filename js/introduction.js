...
// User jumped from verification to introduction page
if (checkauthentication == null) {
// User goes back to verification page
  window.location.replace("/");
}
// User progressed further than the introduction page
else if (checkauthentication != null && checkauthentication != "introduction.html") {
